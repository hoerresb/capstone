...
public class EditTraineesUI extends GymTrack {
	private static final long serialVersionUID = 1L;
	
	public static void createEditTraineesUI(GymTrack gym){
		...
		JLabel lblGymtrack = new JLabel("TODO - create EditTraineesUI");
